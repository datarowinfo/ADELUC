                        ...
                        <ul class="navbar-nav ml-auto bg-dark">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item text-center small text-light" href="#">Detalhes da versão</a>
                                </div>
                            </li>
                    ...
                    <div class="card  border-0">
                        <div class="card-header bg-dark bg-gray-400 text-white">
                            <ul class="nav nav-tabs card-header-tabs bg-gray-400">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active  border-bottom-dark" href="riscos_ACI.php">Risco acidente</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="py-2 container-fluid bg-gray-400">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 bg-dark">
                                    <h6 class="m-0 font-weight-bold text-light">Cadastro de agentes de acidente</h6>
                                </div>
                                    ...
                                    <form class="bg-gray-300 text-dark" method="POST" action="Salvar_Setor.php">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    Tipo: <input id="tipocad" type="text" name="tipo" value = "ACI" disabled class="form-control form-control-sm">
                                                </td>
                                ...
                                <div class="table-responsive bg-gray-300 text-dark">
                                    <table class="table table-striped table-hover table-sm text-dark" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $result_setor = "SELECT * FROM ADELUC.agentesriscos WHERE cod_familia = 'ACI'  and ativo = '1' ORDER BY agente ASC";

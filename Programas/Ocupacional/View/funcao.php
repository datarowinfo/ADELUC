                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="setor.php">Setor</a>
                            <a class="collapse-item active" href="funcao.php">Funcao</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-400">
                        ...
                        <ul class="navbar-nav ml-auto bg-dark">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-white small"><?php echo $_SESSION['UsuarioNome']; ?></span>
                    ...
                    <div class="container-fluid bg-gray-400">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 bg-dark">
                                <h6 class="m-0 font-weight-bold text-light">Cadastro de função</h6>
                            </div>
                            <div class="card-body bg-gray-300">
                                <p>
                                <form class="bg-gray-300 text-dark">
                                    <table>
                                        <tr>

                                            <td>
                                                Descrição da função: <input id="descricaosetor" type="text" class="form-control form-control-sm" name="descricao">
                                            </td>
                                            ...
                                            <td>
                                                Tipo: <input type="text" name="tipo" value = "FUN" disabled class="form-control form-control-sm">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button id="SalvarCadSetor" class="btn btn-secondary btn-icon-split aling-right">
                                                    <span id="iconCadSetor" class="icon text-white-50 fas fa-save">
                                                    </span>
                                                    <span class="text">Salvar</span>
                                                </button>

                                                <button id="LimparCadSetor" class="btn btn-secondary btn-icon-split aling-right">
                    ...
                    <div class="container-fluid bg-gray-400">
                        ...
                        <div class="card shadow mb-4" >
                            <div class="card-header py-3 bg-dark">
                                <h6 class="m-0 font-weight-bold text-light bg-dark">Funções cadastradas</h6>
                            </div>
                            <div class="card-body bg-gray-300">
                                <div class="table-responsive bg-gray-300">
                                    <table class="table table-striped table-hover table-sm" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $result_setor = "SELECT * FROM adeluc.tb_hierarquia WHERE tipo = 'FUN'";

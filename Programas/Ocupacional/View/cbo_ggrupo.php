...
<html lang="pt-br">
    ...
    <head>
        ...
        <link href="../Style/StyleCadastroCBO.css" rel="stylesheet">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="cbo.php">CBO</a>
                            
                            <h6 class="collapse-header">Estrutura de grupo CBO:</h6>
                            
                            <a class="collapse-item active" href="cbo_ggrupo.php">Grande grupo</a>
                    ...
                    <div class="container-fluid bg-gray-400">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 bg-dark">
                                <h6 class="m-0 font-weight-bold text-light">CBO - Grande grupo</h6>
                            </div>
                                ...
                                <form class="bg-gray-300 text-dark" method="POST" action="Salvar_Setor.php">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                Código: <input id="codigo" type="text" class="form-control form-control-sm" name="codigo">
                                            </td>

                                            <td>
                                                Título: <input id="titulo" type="text" class="form-control form-control-sm" name="titulo">
                                            </td>

                                            <td>
                                                Tipo: <input type="text" name="tipo" value = "GRUCBO" disabled class="form-control form-control-sm">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button id="SalvarGrupoCBO" class="btn btn-secondary btn-icon-split aling-right" name="Subject" value="1">
                                                    <span id="iconCadGrupoCBO" class="icon text-white-50 fas fa-save">
                                                    </span>
                                                    <span class="text">Salvar</span>
                                                </button>

                                                <button id="LimparGrupoCBO" class="btn btn-secondary btn-icon-split aling-right" name="Subject" value="2">
                                                    <span id="iconCadGrupoCBO" class="icon text-white-50 fas fa-trash">
                                                    </span>
                                ...
                                <div class="table-responsive bg-gray-300 text-dark">
                                    <table class="table table-striped table-hover table-sm text-dark" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $result_setor = "SELECT * FROM adeluc.tb_grucbo WHERE tipo = 'GRUCBO'";
                                            ...
                                            while ($rows_setor = mysqli_fetch_array($resultado_setor)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $rows_setor['codigo']; ?></td>
                                                    <td><?php echo $rows_setor['titulo']; ?></td>
                                                    <td><?php echo $rows_setor['tipo']; ?></td>

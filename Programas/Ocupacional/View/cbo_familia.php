                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="cbo_familia.php">Familia</a>
                    ...
                    <div class="container-fluid bg-gray-400">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 bg-dark">
                                <h6 class="m-0 font-weight-bold text-light">CBO - Famílias</h6>
                            </div>
                                ...
                                <form class="bg-gray-300 text-dark" method="POST" action="Salvar_Setor.php">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                Tipo: <input type="text" name="tipo" value = "FAMCBO" disabled class="form-control form-control-sm">
                                            </td>
                                ...
                                <div class="table-responsive bg-gray-300 text-dark">
                                    <table class="table table-striped table-hover table-sm text-dark" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $result_setor = "SELECT * FROM adeluc.tb_familiacbo WHERE tipo = 'FAMCBO'";

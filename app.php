...
<head>
   ...
   <title>OLÁ,  <?php echo $_SESSION['UsuarioNome']; ?></title>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.php">Definindo estrutura</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="fisioterapitens" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Fisioterapia:</h6>
                        <a class="collapse-item" href="utilities-color.html">Cadastros</a>
                        <a class="collapse-item" href="utilities-border.html">Avaliações</a>
                        <a class="collapse-item" href="utilities-animation.html">Atendimento</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-white-600 small"><?php echo $_SESSION['UsuarioNome']; ?></span>

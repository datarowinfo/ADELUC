...
<body class="bg-gradient-dark">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="verifica_programa.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="app1.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Programas/Ocupacional/View/buttons.html">CBO</a>
                        <a class="collapse-item" href="Programas/Ocupacional/View/buttons.html">Configuração</a>
                        <a class="collapse-item" href="Programas/Ocupacional/View/todos_riscos.php">Riscos e agentes</a>
                        <a class="collapse-item" href="Programas/Ocupacional/View/buttons.html">Exames</a>
                        <h6 class="collapse-header">Estrutura Organizacional:</h6>
                        <a class="collapse-item" href="Programas/Ocupacional/View/cards.php">Definindo estrutura</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-white-600 small">Lucas Souza</span>
            ...
            <!-- Main Content -->
                    <div id="content">
                        <div class="container-fluid">
                            <img src="image/LogoCentral.jpg" id="Logo">
                        </div>
                    </div>
                </div>
